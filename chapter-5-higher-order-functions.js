...
console.log('\nflatten <><>');
var displayResults = [1,2,3];
flatten([4,5],displayResults);
console.log(displayResults);

function everyItem(arr, com){
...
console.log('\neveryItem <><>');
console.log(everyItem([1,2,3,[4,5]],1));
console.log(everyItem([1,1,1,[1,1]],1));

function someItem(arr, com){
  var flatArr = flattenArray(arr);
  var res = false;
